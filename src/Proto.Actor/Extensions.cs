...
namespace Proto
{
    ...
    {
        public static void Stop(this IEnumerable<PID> self, IActorSystem system)
        {
            if (self == null)
            {
                return;
        ...
        public static void SendSystemMessage(this IEnumerable<PID> self, SystemMessage message, IActorSystem system)
        {
            foreach (var pid in self)
            {
